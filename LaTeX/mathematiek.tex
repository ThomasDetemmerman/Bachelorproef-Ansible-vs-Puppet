...
\lhead{Appendix A: Mathematische berekeningen}
\addcontentsline{toc}{chapter}{Appendix A: Mathematische berekeningen}
...
Gebruikte dataset in appendix C: deploytijden (volledige configuratie)%\ref{dataset:deploytijden}
...
Gebruikte dataset in appendix C: deploytijden (connectietijd) %\ref{dataset:deploytijden}
