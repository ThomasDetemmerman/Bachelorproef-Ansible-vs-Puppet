...
%---------- Voorpagina  ------------------------------------------------------
%\includepdf[pages=-, offset=0 0]{pdf/voorpagina.pdf}
...
\listoffigures
\addcontentsline{toc}{chapter}{\textcolor{maincolor}{Lijst van figuren}}
%\listoftables


%%----------- bijlagen ------------------------
\input{mathematiek}
\input{bachelorproefvoorstel}
\input{datasets}
\includepdf[pages={1-}]{pdf/vrijwaringsclausule.pdf}
